...
1. **Divide**: Wähle ein Element als *Pivot* und partitioniere das Array so, dass alle Elemente kleiner als das Pivot links und alle größeren Elemente rechts davon stehen
...
|**Best Case**
|O(n log n)
|Pivot teilt das Array immer in zwei gleich große Hälften

|**Average Case**
|O(n log n)
|Pivot teilt das Array in etwa gleich große Teile

|**Worst Case**
|O(n²)
|Pivot ist immer das kleinste oder größte Element (bereits sortierte Arrays)
|===
...
Im besten Fall teilt das Pivot-Element das Array immer in zwei gleich große Hälften:
...
Der Worst Case tritt auf, wenn das Pivot immer das kleinste oder größte Element ist:
...
* Nicht stabil
* Rekursive Implementierung kann bei großen Arrays zu Stack Overflow führen
...
for size in [1000, 5000, 10000, 50000]:
    ...
    print(f"Größe {size}: {time_taken:.4f} Sekunden")
----
...
**Problem**: Zugriff außerhalb der Array-Grenzen bei der Partitionierung.
