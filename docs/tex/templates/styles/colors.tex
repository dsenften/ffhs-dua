...
\definecolor[codebackground][r=0.97, g=0.97, b=0.97] % Code-Hintergrund (vim-Modul)
\definecolor[codeborder][r=0.8, g=0.8, b=0.8]     % Code-Rahmen (vim-Modul)
...
% Lernziele-Boxen (FFHS Rot - heller Ton)
\definecolor[lernzielecolor][r=0.8, g=0.1, b=0.1]     % Lernziele-Rahmen (FFHS Rot)
\definecolor[lernzielebgcolor][r=1.0, g=0.95, b=0.95] % Lernziele-Hintergrund (sehr helles Rot)
