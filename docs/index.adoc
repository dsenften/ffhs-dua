...
----
# Nur Fundamentals
uv run python -m pytest tests/test_fundamentals/ -v

# Nur Sorting
uv run python -m pytest tests/test_sorting/ -v

# Nur Quick Sort
uv run python -m pytest tests/test_sorting/test_quick.py -v
----
...
[source,bash]
----
uv run python -m pytest tests/ --cov=src.algs4 --cov-report=html
----
...
│       ├── sorting/               # Sortieralgorithmen
│       │   ├── quick.py           # Quick Sort mit Hoare-Partitionierung
│       │   ├── shell.py           # Shell Sort mit Knuth-Sequenz
│       │   ├── heap.py            # Heap Sort (garantierte O(n log n))
│       │   └── merge.py           # Merge Sort (stabiler Algorithmus)
...
│   ├── pva2/                      # Praktische Vertiefungsaufgaben 2
│   ├── pva3/                      # Praktische Vertiefungsaufgaben 3
│   ├── pva4/                      # Praktische Vertiefungsaufgaben 4
│   └── pva5/                      # Praktische Vertiefungsaufgaben 5
├── src/
...
│   ├── graphs/                    # Graph-Algorithmen (gerichtet/ungerichtet/gewichtet)
│   ├── strings/                   # String-Algorithmen, Texte, Kompression
│   ├── compression/               # Binäre Dateien und Kompressionsalgorithmen
│   ├── small/                     # Kleine Testdaten (< 100KB)
│   ├── medium/                    # Mittlere Datensätze (100KB - 10MB)
│   ├── large/                     # Grosse Datensätze (> 10MB)
│   └── misc/                      # CSV-Dateien und sonstige Anwendungsdaten
...
└── RELEASE_NOTES.html             # Release-Dokumentation
----
