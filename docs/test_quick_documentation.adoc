...
Testet die Groß-/Kleinschreibung bei Strings.
...
**Hinweis:** Großbuchstaben haben in ASCII niedrigere Werte als Kleinbuchstaben.
...
**Testmethodik:**
* Verschiedene Array-Größen (3, 5, 10, 20)
...
==== `test_large_list()`
Testet die Performance mit großen Datenmengen.
...
=== `grosser_datensatz`
Stellt eine große Liste mit 1000 Elementen bereit: `list(range(1000))`
...
* ✅ Gleitkommazahlen
* ✅ Strings (verschiedene Groß-/Kleinschreibung)
...
3. **Performance**: Große Datenmengen werden effizient verarbeitet
