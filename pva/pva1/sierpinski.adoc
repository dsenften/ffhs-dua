...
* **Unendliche Komplexität**: Beliebig viele Details auf allen Massstabsebenen
...
* **Skalierung**: Jede Iteration halbiert die Dreiecksgrösse
...
Erstellen Sie eine Version mit veränderbaren Parametern (Grösse, Iterationen, Farben).

=== Aufgabe 4: Performance-Optimierung
Optimieren Sie den Algorithmus für grosse Iterationszahlen.
