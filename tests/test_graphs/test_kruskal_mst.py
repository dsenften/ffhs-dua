"""Tests für Kruskal's Algorithmus."""

from src.algs4.pva_4_graphs import Edge, EdgeWeightedGraph, KruskalMST


class TestKruskalMST:
    """Tests für die KruskalMST-Klasse."""

    def test_kruskal_einfacher_graph(self):
        """Test Kruskal auf einem einfachen Graphen."""
    ...
    def test_kruskal_gewicht(self):
        """Test dass Kruskal das korrekte Gewicht berechnet."""
        g = EdgeWeightedGraph(4)
        g.add_edge(Edge(0, 1, 0.5))
        g.add_edge(Edge(1, 2, 0.3))
        g.add_edge(Edge(2, 3, 0.2))
    ...
    def test_kruskal_einzelner_knoten(self):
        """Test Kruskal mit nur einem Knoten."""
    ...
    def test_kruskal_zwei_knoten(self):
        """Test Kruskal mit zwei Knoten."""
    ...
    def test_kruskal_komplexer_graph(self):
        """Test Kruskal auf einem komplexeren Graphen."""
    ...
    def test_kruskal_mehrfache_kanten_gleichen_gewichts(self):
        """Test Kruskal mit mehreren Kanten gleichen Gewichts."""
        g = EdgeWeightedGraph(4)
        g.add_edge(Edge(0, 1, 0.5))
    ...
    def test_kruskal_stern_graph(self):
        """Test Kruskal auf einem Stern-Graphen."""
    ...
    def test_kruskal_liniengraph(self):
        """Test Kruskal auf einem Liniengraphen."""
        g = EdgeWeightedGraph(5)
    ...
    def test_kruskal_redundante_kanten(self):
        """Test Kruskal mit redundanten Kanten."""
    ...
    def test_kruskal_gewichte_sind_positiv(self):
