...
class BaseDataType(metaclass=ABCMeta):
    """Abstract class for stack, queue or another collection type."""
...
class Stack(object):
    ...
    def __init__(self, old_stack: Stack = None) -> None:
        """
        Initial method, use `_first` to mark the head of linked list,
        uses `_size` to keep track of linked-list size.
    ...
    def __iter__(self) -> Iterator[Any]:
        """
        Iterate all elements of the current stack.
...
class Bag(object):
    ...
    def __iter__(self) -> Iterator[Any]:
        """
        Iterator method, yields each element in a bag
    ...
    def is_empty(self) -> bool:
        ...
        Returns:
            bool: True if a bag is empty, otherwise False
        >>> bag = Bag()
        >>> bag.is_empty()
        True
        """
...
class Parentheses(object):
    ...
    def is_parenthese_symmetric(self, parenthese_string: str) -> bool:
        ...
        Returns:
            bool: True if parenthese string is symmetric else False
...
class CompleteInfixString(object):
    ...
    def complete_string(self, incmplt_string: str) -> str:
        """
        Complete infix string, `incmplt_string` cannot include `(` character.
...
class Steque(object):
    ...
    def pop(self) -> Union[None, Any]:
        """
        Remove the top element from steque.
