...
public class TraverserTest {
    ...
    public void testRecursiveTraverser() {
        ...
        DepthFirstTraverserRec<String> trav = new DepthFirstTraverserRec<>() {
            @Override
    ...
    public void testDepthFirstTraverserStack() {
        final ArrayList<String> listPre = new ArrayList<>();
        DepthFirstTraverserStack<String> trav = new DepthFirstTraverserStack<>() {
            @Override
    ...
    public void testBreadFirstTraverser() {
        final ArrayList<String> listPre = new ArrayList<>();
        BreadthFirstTraverser<String> trav = new BreadthFirstTraverser<>() {
            @Override
            protected void visitNode(String value) {
                listPre.add(value);
            }
